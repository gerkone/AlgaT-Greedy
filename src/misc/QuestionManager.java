										...
										= new ArrayList<Question>(){
																{
																	...
																	add(new Question("Ad ogni iterazione, \"viene eliminato\"", "pi" + (char)249 +" lungo", "con scadenza minore", "pi" + (char)249 + " breve", "con scadenza maggiore", 1));
																}
	};
										...
										= new ArrayList<Question>() {
																{
																	...
																	add(new Question("Quale metodo di ordinamento per lo zaino " + (char)232 + " mancante? \npeso massimo, profitto massimo, _________", "peso minimo", "prima i pesi maggiori di k" ,"profitto specifico", "profitto minimo", 3));
																	add(new Question("Cosa significa \"partizioabile\"?", "gli oggetti solo formati da pi" + (char)249 + " parti", "gli oggetti possono essere divisi, partizionando massa e profitto", "gli oggetti hanno come massa un numero primo", "gli oggetti hanno tutti profitto nullo", 2));
																	...
																	add(new Question("Lo zaino \"0/1\" " + (char)232 + " realizzabile usando la programmazione greedy?", "si, " + (char)232 + " il modo migliore", "si, ma solo se i pesi sono positivi", "no, non " + (char)232 + " realizzabile", "si, ma non restituisce sempre la soluzione ottima", 4));
																}
